...
/**
 * REST controller for managing {@link com.universign.universigncs.connector.domain.Profile}.
 */
@RestController
@RequestMapping("/api")
public class ProfileResource {
     ...
     */
    @GetMapping("/profiles")
    public ResponseEntity<List<Profile>> getAllProfiles(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
